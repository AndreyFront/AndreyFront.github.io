...
function reviews() {
    ...
    mains.forEach(main => {
        ...
        btnMore.addEventListener('click', () => {
            ...
            btnMore.style.display = 'none'
            if (window.matchMedia("(max-width: 992px)").matches) wrapperReviews.scrollIntoView()
        })
    })
}
...
function technic() {
    ...
    mains.forEach(main => {
        ...
        const pagination = main.querySelector('[data-technic="pagination"]')
