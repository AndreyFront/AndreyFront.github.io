...
function tooltip() {
    ...
    document.addEventListener('mouseover', (event) => {
        ...
        if (el.closest('[data-tooltip="main"]')) {
            ...
            if (parameters.top - 20 < 0 && !main.classList.contains('tooltip--orientation--bottom')) {
